...
__global__ void transfer(float *A, float *B, float *C){
...
__global__ void transfer2(float *A, float *B, float *C){
...
__global__ void transfer3(float *A, float *B, float *C){
...
__global__ void transfer4(float *A, float *B, float *C){
    __shared__ float A_part[2][SMEM_X][SMEM_Y], B_part[2][SMEM_X][SMEM_Y];
    ...
    for(int j = 0; j < num_shared_data_per_thread; j++){
        ...
        // int A_glo_x = ((tiy * BLOCK_X + tix) * num_shared_data_per_thread % SMEM_X) * num_shared_data_per_thread;
...
__host__ void callDGEMM(float * d_A, float * d_B, float * d_C){
    ...
    switch(kernelIdx){
        case 1:
            ...
            transfer<<<gridSize, blockSize>>>(d_A, d_B, d_C);
            break;
        case 2:
            blockSize = {BLOCK_X, BLOCK_Y};
            gridSize = {N/SMEM_Y, M/SMEM_Y};
            ...
            printf("gridSize:  (%d, %d, %d)\n", gridSize.x, gridSize.y, gridSize.z);
            printf("blockSize: (%d, %d, %d)\n", blockSize.x, blockSize.y, blockSize.z);
            transfer2<<<gridSize, blockSize>>>(d_A, d_B, d_C);
            break;
        case 3:
            blockSize = {BLOCK_X, BLOCK_Y};
            gridSize = {N/SMEM_Y, M/SMEM_Y};
            ...
            printf("gridSize:  (%d, %d, %d)\n", gridSize.x, gridSize.y, gridSize.z);
            printf("blockSize: (%d, %d, %d)\n", blockSize.x, blockSize.y, blockSize.z);
            transfer3<<<gridSize, blockSize>>>(d_A, d_B, d_C);
            break;
        case 4:
            blockSize = {BLOCK_X, BLOCK_Y};
            gridSize = {N/SMEM_Y, M/SMEM_Y};
            ...
            printf("gridSize:  (%d, %d, %d)\n", gridSize.x, gridSize.y, gridSize.z);
            printf("blockSize: (%d, %d, %d)\n", blockSize.x, blockSize.y, blockSize.z);
            transfer4<<<gridSize, blockSize>>>(d_A, d_B, d_C);
            break;
        default:
            break;
    }
