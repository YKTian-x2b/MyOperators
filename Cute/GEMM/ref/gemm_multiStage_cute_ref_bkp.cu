...
// nvcc --generate-code arch=compute_86,code=sm_86  --expt-relaxed-constexpr \
 -I/usr/local/cuda/include -I/home/yujixuan/kaiPro/cute-gemm-main/3rd/cutlass/include \
 -L/usr/local/cuda/lib64 -l cuda -l cublas \
 -o ../res/gemm_multiStage_cute_ref_bkp gemm_multiStage_cute_ref_bkp.cu

// ncu -f -o ../res/gemm_multiStage_cute_ref_bkp_prof --set full --cache-control=all \
 --clock-control=base ../res/gemm_multiStage_cute_ref_bkp